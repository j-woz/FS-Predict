...
$ python server.py -m usetft   -k ckpt_path=./saved_models/tft.ckpt   -k dataset_path=./saved_models/tft_dataset.pkl   -k encoder_len=50   -k horizon=20   -k device=cuda   -k batch_size=64   -s ../tmp/sus/sock.s
----
